---
title: "GT DevX session at the GDR SciLog 2026 conference"
date: 2026-06-02
language: en
---
...
It is important to define how to measure developer experience using metrics (efficiency, satisfaction) and how to assess the real impact of tools.
But DevX evaluation also appears to be interdisciplinary, integrating cognitive psychology (understanding needs related to emotions or perceived difficulty), as well as the principles of User Experience (UX) and Human-Computer Interaction (HCI) applied to developers.
